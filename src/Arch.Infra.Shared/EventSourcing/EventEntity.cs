...
namespace Arch.Infra.Shared.EventSourcing
{
    public class EventEntity
    {
        ...
        public static EventEntity GetEvent(string action, dynamic entity, ICommand command, string who, object lastEntity = null)
        {
            ...
            result.Data = BuildJsonDataCommand(entity, command, lastEntity);
            result.AggregateId = entity.Id;
            result.Who = who;
            result.Assembly = entity.GetType().FullName;
        ...
        private static string BuildJsonDataCommand(object entity, ICommand command, object lastEntity = null)
        {
            ...
            if (lastEntity != null)
            {
                var modifieds = GetMembersUpdated(command, lastEntity);
            ...
            jo.Property("Id")?.Remove();
            jo.Property("ValidationResult")?.Remove();
            jo.Property("Action")?.Remove();
            jo.Property("AggregateId")?.Remove();
        ...
        private static string[] GetMembersUpdated(object objOrig, object objModified)
        {
